...
def main():
    ...
    # Updated path for the new model
    checkpoint_path = "models/sebra_weighted/checkpoint.pth"
    final_model_path = "models/sebra_weighted/final_model.pth"
    os.makedirs("models/sebra_weighted", exist_ok=True)
    ...
    # n=92,730, y=26,160 -> Weight ratio 3.54
    ...
    print(f"Finished. Final model: {final_model_path}")
